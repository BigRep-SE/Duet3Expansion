...
#ifndef SRC_CONFIG_CB_SE_V04_H_
#define SRC_CONFIG_CB_SE_V04_H_

#include <Hardware/PinDescription.h>

#define BOARD_TYPE_NAME		"CB-SE-04"
#define BOOTLOADER_NAME		"CB-SE-04"
...
#define SUPPORT_LED_STATES		1
#define SUPPORT_EEPROM_MEMORY	0

#define SUPPORT_FILAMENT_SENSOR	1
...
constexpr Pin BoardTypePin = { PortAPin(4) };
...
constexpr Pin TempSensePins[NumThermistorInputs] 		= { PortBPin(7),  PortBPin(8)};
...
constexpr Pin StepPins[NumDrivers] 				= { PortAPin(24) };
constexpr Pin DirectionPins[NumDrivers] 		= { PortAPin(23) };
constexpr Pin DriverDiagPins[NumDrivers]		= { PortAPin(20) };
constexpr Pin GlobalTmc22xxEnablePin 			= PortAPin(25);

// Diagnostic LEDs ------------------------------------------------------
constexpr Pin LedPins[] 	= { PortBPin(3), PortAPin(18) };
constexpr bool LedActiveHigh = false;

// Monitor --------------------------------------------------------------
constexpr Pin VinMonitorPin = PortBPin(9);
...
constexpr Pin I2CEepromPin = PortBPin(22);
#endif

#endif

#if SUPPORT_ADXL345
constexpr Pin ADXL345Int1Pin 		= PortAPin(12);
#define SUPPORT_ADXL345_ALT_ADDR
#endif

#if SUPPORT_LED_STATES
constexpr uint8_t LedStripSercomNumber 			= 4;
Sercom * const SERCOM_LEDSTRIP 					= SERCOM4;
constexpr Pin LedStripPin 						= PortAPin(13);
constexpr GpioPinFunction LedStripPinPeriphMode = GpioPinFunction::D;
#endif
...
constexpr Pin SSPICSPin = PortBPin(2);
#endif
...
constexpr PinDescription PinTable[] =
{
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA01 unused
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA04 BOARD_TYPE
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		5, "fan0.tach"		},	// PA05 FAN0_TAC
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		6, "fan1.tach"		},	// PA06 FAN1_TAC
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PA07 unused
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PA08 I2C | SDA
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA09 I2C | SCL
	{ TcOutput::none,	TccOutput::tcc0_2F,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"heater,out0"	},	// PA10 OUT_0 , Heater
	{ TcOutput::none,	TccOutput::tcc1_7G,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"fan0,out1"		},	// PA11 OUT_1 , Fan 0
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		12,	nullptr			},	// PA12 Accelerometer | INT
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA13 LED Strip
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA16 SPI | MOSI
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA17 SPI | CLK
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr 		},	// PA18 LED | ACT
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA19 SPI | MISO
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		4,	"ate.d0.diag0"	},	// PA20 MOTOR 0 | Diag
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA21 unused
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA22 unused
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"ate.d0.step"	},	// PA23 MOTOR 0 | Step
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, "ate.d0.dir"	},	// PA24 MOTOR 0 | Direction
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA25 MOTORS  | Enable
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA26 not on chip
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PA27 unused
	...
	// Port B
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		0,	"io0.in,filam"	},	// PB00 IO_0_IN , Filament monitor
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr 		},	// PB01 SPI | CS 1
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr 		},	// PB02 SPI | CS 0
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PB03 LED | Status
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::adc1_9,	SercomIo::none,		SercomIo::none,		Nx,	"temp0"			},	// PB07 TEMP0
	{ TcOutput::none,	TccOutput::none,	AdcInput::adc1_0,	SercomIo::none,		SercomIo::none,		Nx,	"temp1"			},	// PB08	TEMP1
	{ TcOutput::none,	TccOutput::none,	AdcInput::adc1_1,	SercomIo::none,		SercomIo::none,		Nx,	"ate.vin"		},	// PB09 VIN
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PB10 unused
	{ TcOutput::tc5_1,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, "fan1,out2"		},	// PB11 OUT_2, Fan 2
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, "fan3,out4"		},	// PB14 OUT_4, Fan 3
	{ TcOutput::none,	TccOutput::tcc4_1F,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"fan2,out3"		},	// PB15 OUT_3, Fan 2
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PB22 MEM WC
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		7,  "io3.in"		},	// PB23 IO_3_IN
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		14,	"io2.in"		},	// PB30 IO_2_IN
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		15,	"io1.in"		},	// PB31 IO_1_IN
};
...
#if SUPPORT_LED_STATES
constexpr DmaChannel DmacChanLedStrip  = 5;
...
constexpr DmaPriority DmacPrioLedStrip = 4;
#else
