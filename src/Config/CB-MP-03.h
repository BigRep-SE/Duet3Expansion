...
#ifndef SRC_CONFIG_CB_MP_V03_H_
#define SRC_CONFIG_CB_MP_V03_H_

#include <Hardware/PinDescription.h>

#define BOARD_TYPE_NAME		"CB-MP-03"
#define BOOTLOADER_NAME		"CB-MP-03"
...
constexpr Pin BoardTypePins[NumBoardTypeBits] 			= { PortAPin(6) };
constexpr Pin BoardAddressPins[NumAddressBits] 			= { PortAPin(0), PortAPin(1), PortBPin(16) };
...
constexpr uint8_t I2CSercomNumber = 0;
constexpr Pin I2CSDAPin = PortAPin(8);
constexpr GpioPinFunction I2CSDAPinPeriphMode = GpioPinFunction::C;
constexpr Pin I2CSCLPin = PortAPin(9);
constexpr GpioPinFunction I2CSCLPinPeriphMode = GpioPinFunction::C;
#define I2C_HANDLER0		SERCOM0_0_Handler
#define I2C_HANDLER1		SERCOM0_1_Handler
#define I2C_HANDLER3		SERCOM0_2_Handler
...
constexpr PinDescription PinTable[] =
{
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PA06 BoardType & Encoder | CS
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::adc1_0,	SercomIo::none,		SercomIo::none,		8,	"temp2"			},	// PB08 ADC 	| Analog 0-10V
	{ TcOutput::none,	TccOutput::none,	AdcInput::adc1_1,	SercomIo::none,		SercomIo::none,		Nx,	"temp1"			},	// PB09 ADC 	| Temperature 1
