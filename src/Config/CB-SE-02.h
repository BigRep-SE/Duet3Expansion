...
#ifndef SRC_CONFIG_CB_SE_V02_H_
#define SRC_CONFIG_CB_SE_V02_H_

#include <Hardware/PinDescription.h>

#define BOARD_TYPE_NAME		"CB-SE-02"
#define BOOTLOADER_NAME		"CB-SE-02"
...
constexpr Pin BoardAddressPins[NumAddressBits] 	= { PortAPin(24), PortBPin(23) };
...
constexpr uint8_t TMC22xxSercomNumber = 2;
Sercom * const SERCOM_TMC22xx = SERCOM2;

constexpr Pin TMC22xxSercomTxPin = PortAPin(12);
constexpr GpioPinFunction TMC22xxSercomTxPinPeriphMode = GpioPinFunction::C;
constexpr Pin TMC22xxSercomRxPin = PortAPin(13);
constexpr GpioPinFunction TMC22xxSercomRxPinPeriphMode = GpioPinFunction::C;
constexpr uint8_t TMC22xxSercomRxPad = 1;			// SERCOM2/PAD[1]
...
constexpr Pin DriverDiagPins[NumDrivers]		= { PortAPin(11) };
constexpr Pin GlobalTmc22xxEnablePin 			= PortAPin(8);


// Diagnostic LEDs ------------------------------------------------------
constexpr Pin LedPins[] 	= { PortBPin(10), PortBPin(11) };
...
#define I2C_HANDLER0		SERCOM1_0_Handler
#define I2C_HANDLER1		SERCOM1_1_Handler
#define I2C_HANDLER3		SERCOM1_2_Handler

#endif

#if SUPPORT_PCA9685
constexpr uint8_t ledsStripHorizontal[][3] = {{13,14,15},{10,11,12},{7,8,9},{4,5,6},{1,2,3}};
constexpr uint8_t ledsStripHorizontalLength = 5;
constexpr uint8_t ledsStripVertical[][3] = {{13,14,15},{10,11,12},{7,8,9},{4,5,6}};
constexpr uint8_t ledsStripVerticalLength = 4;
#endif

#if SUPPORT_ADXL345
constexpr Pin ADXL345Int1Pin 		= PortAPin(25);
...
constexpr PinDescription PinTable[] =
{
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PA05 unused
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PA06 unused
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PA07 unused
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PA08 DRIVER ENN
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"ate.d0.step"	},	// PA09 DRIVER_0 STEP
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"ate.d0.dir"	},	// PA10 DRIVER_0 DIR
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		11,	"ate.d0.diag0"	},	// PA11 DRIVER_0 DIAG
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA12 DRIVER USART Tx (SERCOM2[0])
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PA13 DRIVER USART Rx (SERCOM2[1])
	...
	{ TcOutput::none,	TccOutput::tcc1_2F,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"out5" 			},	// PA18 SELECTED-LED0
	{ TcOutput::tc3_1,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"fan0"			},	// PA19 Fan0
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		4,	"io1.in"		},	// PA20 IN1
	{ TcOutput::none,	TccOutput::tcc0_1G,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"fan2"			},	// PA21 Fan2
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		6,	"io0.in"		},	// PA22 IN0
	{ TcOutput::tc4_1,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"fan3"			},	// PA23 Fan3
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PA24 ADDRESS_0
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		9,	nullptr			},	// PA25 ACCEL-INT
	...
	// Port B
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	nullptr			},	// PB00 unused
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PB10 STATUS LED
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PB11 ACTIVITY LED
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PB14 unused
	{ TcOutput::tc5_1,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"heater"		},	// PB15 OUT0
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"out6" 			},	// PB16 SELECTED-LED1
	{ TcOutput::none,	TccOutput::tcc3_1F,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx,	"fan1" 			},	// PB17 Fan1
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PB22 unused
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		Nx, nullptr			},	// PB23 ADDRESS_1
	...
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		14,	"io2.in"		},	// PB30 BUTTON_0
	{ TcOutput::none,	TccOutput::none,	AdcInput::none,		SercomIo::none,		SercomIo::none,		15,	"io3.in"		},	// PB31 BUTTON_1
};
