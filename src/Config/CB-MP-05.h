...
#ifndef SRC_CONFIG_CB_MP_V05_H_
#define SRC_CONFIG_CB_MP_V05_H_

#include <Hardware/PinDescription.h>

#define BOARD_TYPE_NAME		"CB-MP-05"
#define BOOTLOADER_NAME		"CB-MP-05"
