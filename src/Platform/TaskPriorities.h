...
namespace TaskPriority
{
	...
	static constexpr unsigned int LedStates = 2;
	static constexpr unsigned int FilamentMemory = 2;
	static constexpr unsigned int DHTSensor = 2;
	...
	static constexpr unsigned int PlasmicsPriority = 3;
	static constexpr unsigned int ClosedLoopDataTransmission = 3;
	static constexpr unsigned int AdcStream = 3;
